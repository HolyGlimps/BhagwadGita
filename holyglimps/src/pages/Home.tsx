            ...
            <div className="min-h-screen flex flex-col">
                ...
                <nav className="bg-orange-400 p-4">
                    <div className="flex justify-between items-center">
                        <a href="#" className="text-white font-semibold text-xl">Home</a>
                        ...
                        <div className={styles.signup}>
                            {session && session.user ? (
                                <button className="text-white font-semibold text-xl" onClick={() => signOut()}>Sign out</button>
                            ) : (
                        ...
                        {session && session.user ? (
                            <div>
                                <p className="text-2xl font-semibold text-blue-500 pb-1">
                                    ...
                                    Get Ready to read the ultimate bhagwat gita <hr />
                                </p>
                            ...
                            <>
                                ...
                                <button className="text-black border border-gray-400 rounded-md px-1 font-bold text-xl" onClick={() => signIn()}>Sign in</button>
                            </>
